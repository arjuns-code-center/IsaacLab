...
import omni.isaac.lab_tasks.manager_based.locomotion.velocity.config.husky_beta.mdp as husky_beta_mdp
...
# Pre-defined configs
##
from omni.isaac.lab_assets.husky_beta import HUSKY_B_CFG  # isort: skip
...
@configclass
class HuskyBetaObservationsCfg:
...
@configclass
class HuskyBetaTerminationsCfg:
...
class HuskyBetaFlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    actions: HuskyBetaActionsCfg = HuskyBetaActionsCfg()
    commands: HuskyBetaCommandsCfg = HuskyBetaCommandsCfg()

    # MDP setting
    rewards: HuskyBetaRewardsCfg = HuskyBetaRewardsCfg()
    terminations: HuskyBetaTerminationsCfg = HuskyBetaTerminationsCfg()
